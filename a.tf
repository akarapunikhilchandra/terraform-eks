...
#   name    = aws_acm_certificate.eks_cluster_certificate.domain_validation_options.resource_record_name
#   type    = aws_acm_certificate.eks_cluster_certificate.domain_validation_options.resource_record_type
#   zone_id = "Z0686921XP2M57OZO3Y7"
#   records = [aws_acm_certificate.eks_cluster_certificate.domain_validation_options.resource_record_value]
#   ttl     = 60
# }
# Create ACM Certificate Validation Record
# resource "aws_route53_record" "acm_validation" {
...
#   name    = aws_acm_certificate.eks_cluster_certificate.domain_validation_options[count.index].resource_record_name
#   type    = aws_acm_certificate.eks_cluster_certificate.domain_validation_options[count.index].resource_record_type
#   zone_id = "Z0686921XP2M57OZO3Y7"
#   records = [aws_acm_certificate.eks_cluster_certificate.domain_validation_options[count.index].resource_record_value]
#   ttl     = 60
# }
